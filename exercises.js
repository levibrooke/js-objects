...
buildPerson(plainPerson, "Levi Porter", 21);
console.log(plainPerson);

var completePerson = buildPerson(plainPerson, "Levi Porter", 21);
...
function putInPlainBox(obj){
  for (var i = 0; i < 11; i++) {
    obj.contents.push(Math.floor(Math.random()* 10 + 1));
  }
  return obj;
}
...
function detectingTransmission(obj){
  if (obj.automaticTransmission === true) {
    ...
    return "This car has a stick shift";
  }
}
...
var stockCarWithDriver = addDriver(stockCar, "Jeff Gordon");
